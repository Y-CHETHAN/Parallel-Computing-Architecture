...
1. The program will start executing, and the name of the device being used will be printed on the console.
...
## Result:
The block size 1023 performs better in the GPU with an elapsed time of 0.003 seconds, and the block size 1024 shows better results in the host with an elapsed time of 0.019 seconds. Using a block size of 256 and two threads simultaneously has provided the best results in the GPU with an elapsed time of 0.0019 seconds.
